...
if(WIN32)
	...
	if(${SDK_32bits})
		#32 bit SDK
		set(edison_sdk_root C:/Edison/poky-edison-eglibc-i686-edison-image-core2-32-toolchain-1.6.1)
		...
		#64 bit SDK
		set(edison_sdk_root C:/Intel/iotdk-ide-win/devkit-x86)
...
set(CMAKE_SYSROOT ${edison_sdk_root}/sysroots/i586-poky-linux)
...
INCLUDE_DIRECTORIES(${CMAKE_SYSROOT}/usr/include/lua)
